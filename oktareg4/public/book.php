...
$stmt->bind_param('ssss',$timeslot,$date,$_SESSION['username'],$event);
$stmt->execute();
...
<div id="myModal"class="modal fade"role="dialog">
  <div class="modal-dialog">
	...
	<!-- Sanitize data here inculding timeslot/limit input length to prevent bufferoverflow-->
	
		<div class="form-group">
		<label for="">Timeslot</label>
		<input required type="text"name="timeslot" maxlength="15" id="timeslot"pattern="[A-Za-z0-9:-]+"class="form-control">
      </div>
	 
	  <div class="form-group">
		<label required type="">Event</label>
		<input type="text"name="event" maxlength="100" pattern="[A-Za-z0-9\s\.,']+"class="form-control">
      </div>
